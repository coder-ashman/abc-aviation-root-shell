        ...
        try {
            if (!remoteEntryExports) {
                if (typeof FEDERATION_ALLOW_NEW_FUNCTION !== 'undefined') {
                    ...
                    __vitePreload(() => import(/* webpackIgnore: true */ /* @vite-ignore */ entry),true?[]:void 0).then(resolve).catch(reject);
                }
            } else {
...
let initResolve, initReject;
    ...
    var owner_mf_2_portal_mf_2_web__mf_v__runtimeInit__mf_v__ = {
      initPromise,
      initResolve,
      initReject
    };

export { init_1 as a, index_cjs$3 as i, owner_mf_2_portal_mf_2_web__mf_v__runtimeInit__mf_v__ as o };
